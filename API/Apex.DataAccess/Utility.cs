...
namespace Apex.DataAccess
{
    public class Utility
    {
        ...
        private const string _LocalConnectionString =
            "Server=127.0.0.1;Database=logicly;User Id=root;Pwd=";

        public static string ConnectionString = _LocalConnectionString;
